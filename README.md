...
Deloper since 2019, now woring with Android, using Kotlin and sometimes Java, but I really want to become a full-stack developer, develop since from games on Unity until Back-end applications. Know a little bit of everything is important to see all the perspectives, and to find yourself in this huge environment.
